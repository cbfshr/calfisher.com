  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
      ...
      $destroy: function() {
        ...
        //(James Clevenger) Commented out above two lines per this page https://github.com/angular/angular.js/issues/1627
        //experiencing this issue when chaning location from a view that uses a directive
        // made the change based on comment from "murilobr"
